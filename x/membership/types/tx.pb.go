...
func (m *MsgApproveMember) Reset()         { *m = MsgApproveMember{} }
func (m *MsgApproveMember) String() string { return proto.CompactTextString(m) }
func (*MsgApproveMember) ProtoMessage()    {}
func (*MsgApproveMember) Descriptor() ([]byte, []int) {
	return fileDescriptor_c82c40c64be48422, []int{4}
}
func (m *MsgApproveMember) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgApproveMember) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgApproveMember.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgApproveMember) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgApproveMember.Merge(m, src)
}
func (m *MsgApproveMember) XXX_Size() int {
	return m.Size()
}
func (m *MsgApproveMember) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgApproveMember.DiscardUnknown(m)
}

var xxx_messageInfo_MsgApproveMember proto.InternalMessageInfo

func (m *MsgApproveMember) GetApprover() string {
	if m != nil {
		return m.Approver
	}
	return ""
...
func (m *MsgApproveMember) GetMember() string {
	if m != nil {
		return m.Member
	}
	return ""
...
type MsgApproveMemberResponse struct {
}

func (m *MsgApproveMemberResponse) Reset()         { *m = MsgApproveMemberResponse{} }
func (m *MsgApproveMemberResponse) String() string { return proto.CompactTextString(m) }
func (*MsgApproveMemberResponse) ProtoMessage()    {}
func (*MsgApproveMemberResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c82c40c64be48422, []int{5}
}
func (m *MsgApproveMemberResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgApproveMemberResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgApproveMemberResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgApproveMemberResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgApproveMemberResponse.Merge(m, src)
}
func (m *MsgApproveMemberResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgApproveMemberResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgApproveMemberResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgApproveMemberResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgApproveMember)(nil), "membershipmodule.membership.MsgApproveMember")
	proto.RegisterType((*MsgApproveMemberResponse)(nil), "membershipmodule.membership.MsgApproveMemberResponse")
}
...
var fileDescriptor_c82c40c64be48422 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	ApproveMember(ctx context.Context, in *MsgApproveMember, opts ...grpc.CallOption) (*MsgApproveMemberResponse, error)
}
...
func (c *msgClient) ApproveMember(ctx context.Context, in *MsgApproveMember, opts ...grpc.CallOption) (*MsgApproveMemberResponse, error) {
	out := new(MsgApproveMemberResponse)
	err := c.cc.Invoke(ctx, "/membershipmodule.membership.Msg/ApproveMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// ApproveMember approves a member's enrollment
	ApproveMember(context.Context, *MsgApproveMember) (*MsgApproveMemberResponse, error)
}
...
func (*UnimplementedMsgServer) ApproveMember(ctx context.Context, req *MsgApproveMember) (*MsgApproveMemberResponse, error) {
...
func _Msg_ApproveMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgApproveMember)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).ApproveMember(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/membershipmodule.membership.Msg/ApproveMember",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).ApproveMember(ctx, req.(*MsgApproveMember))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Msg_ApproveMember_Handler,
		},
	},
...
func (m *MsgApproveMember) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgApproveMember) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgApproveMember) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgApproveMemberResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgApproveMemberResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgApproveMemberResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgApproveMember) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgApproveMemberResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgApproveMember) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgApproveMember: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgApproveMember: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgApproveMemberResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgApproveMemberResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgApproveMemberResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
